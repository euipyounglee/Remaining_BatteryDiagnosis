...
{
	public class CTS_VARIABLE_CH_DATA_D_DTO : ICTS_VARIABLE_CH_DATA_DTO
	{
		#region property
		...
		/// Aux Data
		/// </summary>
		public List<CTS_AUX_DATA_D_DTO> AuxData { get; set; }
		...
		public CTS_VARIABLE_CH_DATA_D_DTO(CTS_VARIABLE_CH_DATA_D src)
		{
			ChData = new CTS_CH_DATA_DTO(src.chData);

			AuxData = new List<CTS_AUX_DATA_D_DTO>();
			foreach (var data in src.auxData)
			{
				AuxData.Add(new CTS_AUX_DATA_D_DTO(data));
			}
